...
static Rx2ChannelParams_t Rx2ChannelDefault = RX_WND_2_CHANNEL;
...
static void ResetMacParameters( void )
{
    ...
    memcpy1( ( uint8_t* ) &Rx2Channel, ( uint8_t* )&Rx2ChannelDefault, sizeof(Rx2Channel) );
