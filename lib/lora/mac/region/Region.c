...
#define AS923_GET_CHANNEL_MASK( )                  AS923_CASE { return RegionAS923GetChannelMask( channelmask, size ); }
...
#define AU915_GET_CHANNEL_MASK( )                  AU915_CASE { return RegionAU915GetChannelMask( channelmask, size ); }
#define AU915_GET_CHANNEL_MASK_REMAINING( )        AU915_CASE { return RegionAU915GetChannelMaskRemaining( channelmask, size ); }
...
#define EU868_GET_CHANNEL_MASK( )                  EU868_CASE { return RegionEU868GetChannelMask( channelmask, size ); }
...
#define US915_GET_CHANNEL_MASK( )                  US915_CASE { return RegionUS915GetChannelMask( channelmask, size ); }
#define US915_GET_CHANNEL_MASK_REMAINING( )        US915_CASE { return RegionUS915GetChannelMaskRemaining( channelmask, size ); }
...
#define US915_HYBRID_GET_CHANNEL_MASK( )                  US915_HYBRID_CASE { return RegionUS915HybridGetChannelMask( channelmask, size ); }
#define US915_HYBRID_GET_CHANNEL_MASK_REMAINING( )        US915_HYBRID_CASE { return RegionUS915HybridGetChannelMaskRemaining( channelmask, size ); }
