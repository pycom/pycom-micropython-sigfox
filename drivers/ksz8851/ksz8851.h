...
/*****************************************************************************
*
* MAC address assigned to the KSZ8851
*
*****************************************************************************/
...
extern uint8_t ethernet_mac[ETH_MAC_SIZE];
...
* (Offset 0x00 - 0x25)
*/
#define   REG_CHIP_CFG_STATUS         0x08      /* CCR */
...
#define   REG_MAC_ADDR_01             0x10       /* MARL */
#define   REG_MAC_ADDR_23             0x12       /* MARM */
#define   REG_MAC_ADDR_45             0x14       /* MARH */
...
#define   RXQ_CMD_CNTL                (RXQ_FRAME_CNT_INT|RXQ_TWOBYTE_OFFSET|RXQ_AUTO_DEQUEUE)
...
#define   REG_RX_FRAME_CNT_THRES      0x9C       /* RXFCTR */
