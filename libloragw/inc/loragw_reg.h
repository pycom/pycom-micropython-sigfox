...
#define LGW_com_RADIO_A__DATA 249
#define LGW_com_RADIO_A__DATA_READBACK 250
#define LGW_com_RADIO_A__ADDR 251
#define LGW_com_RADIO_A__CS 252
#define LGW_com_RADIO_B__DATA 253
#define LGW_com_RADIO_B__DATA_READBACK 254
#define LGW_com_RADIO_B__ADDR 255
#define LGW_com_RADIO_B__CS 256
...
#define LGW_com_DATA_FIFO_PTR 299
#define LGW_PACKET_DATA_FIFO_PTR 300
#define LGW_DBG_ARB_MCU_RAM_ADDR 301
#define LGW_DBG_AGC_MCU_RAM_ADDR 302
#define LGW_com_MASTER_CHIP_SELECT_POLARITY 303
#define LGW_com_MASTER_CPOL 304
#define LGW_com_MASTER_CPHA 305
...
#define STM32FWVERSION 0x23040900
/* -------------------------------------------------------------------------- */
/* --- PUBLIC FUNCTIONS PROTOTYPES ------------------------------------------ */

/**
@brief Connect LoRa concentrator by opening SPI link
@param com_only indicates if we only want to create the SPI connexion to the
