...
int reg_w_align32(void *spi_target, uint8_t spi_mux_mode, uint8_t spi_mux_target, const struct lgw_reg_s *r, int32_t reg_value) {
    int i, size_byte;
...
int reg_r_align32(void *spi_target, uint8_t spi_mux_mode, uint8_t spi_mux_target, const struct lgw_reg_s *r, int32_t *reg_value) {
