...
def main():
    ...
    try:
        ...
        shutil.copy(os.environ['IDF_PATH'] + '/components/esp_wifi/lib/esp32/libphy.a', dsttmpapp)
        shutil.copy(os.environ['IDF_PATH'] + '/components/esp_wifi/lib/esp32/librtc.a', dsttmpapp)
        shutil.copy(os.environ['IDF_PATH'] + '/components/esp_wifi/lib/esp32/libnet80211.a', dsttmpapp)
        shutil.copy(os.environ['IDF_PATH'] + '/components/esp_wifi/lib/esp32/libpp.a', dsttmpapp)
        shutil.copy(os.environ['IDF_PATH'] + '/components/esp_wifi/lib/esp32/libcore.a', dsttmpapp)
        shutil.copy(os.environ['IDF_PATH'] + '/components/esp_wifi/lib/esp32/libmesh.a', dsttmpapp)
