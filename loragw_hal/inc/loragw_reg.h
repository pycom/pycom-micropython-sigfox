...
#define LGW_EMERGENCY_FORCE_HOST_CTRL 80
#define LGW_RX_INVERT_IQ 81
#define LGW_MODEM_INVERT_IQ 82
#define LGW_MBWSSF_MODEM_INVERT_IQ 83
#define LGW_RX_EDGE_SELECT 84
#define LGW_MISC_RADIO_EN 85
#define LGW_FILTER_GAIN 86
#define LGW_RADIO_SELECT 87
#define LGW_IF_FREQ_0 88
#define LGW_IF_FREQ_1 89
#define LGW_IF_FREQ_2 90
#define LGW_IF_FREQ_3 91
#define LGW_IF_FREQ_4 92
#define LGW_IF_FREQ_5 93
#define LGW_IF_FREQ_6 94
#define LGW_IF_FREQ_7 95
#define LGW_IF_FREQ_8 96
#define LGW_IF_FREQ_9 97
#define LGW_CHANN_OVERRIDE_AGC_GAIN 98
#define LGW_CHANN_AGC_GAIN 99
#define LGW_CORR0_DETECT_EN 100
#define LGW_CORR1_DETECT_EN 101
#define LGW_CORR2_DETECT_EN 102
#define LGW_CORR3_DETECT_EN 103
#define LGW_CORR4_DETECT_EN 104
#define LGW_CORR5_DETECT_EN 105
#define LGW_CORR6_DETECT_EN 106
#define LGW_CORR7_DETECT_EN 107
#define LGW_CORR_SAME_PEAKS_OPTION_SF6 108
#define LGW_CORR_SAME_PEAKS_OPTION_SF7 109
#define LGW_CORR_SAME_PEAKS_OPTION_SF8 110
#define LGW_CORR_SAME_PEAKS_OPTION_SF9 111
#define LGW_CORR_SAME_PEAKS_OPTION_SF10 112
#define LGW_CORR_SAME_PEAKS_OPTION_SF11 113
#define LGW_CORR_SAME_PEAKS_OPTION_SF12 114
#define LGW_CORR_SIG_NOISE_RATIO_SF6 115
#define LGW_CORR_SIG_NOISE_RATIO_SF7 116
#define LGW_CORR_SIG_NOISE_RATIO_SF8 117
#define LGW_CORR_SIG_NOISE_RATIO_SF9 118
#define LGW_CORR_SIG_NOISE_RATIO_SF10 119
#define LGW_CORR_SIG_NOISE_RATIO_SF11 120
#define LGW_CORR_SIG_NOISE_RATIO_SF12 121
#define LGW_CORR_NUM_SAME_PEAK 122
#define LGW_CORR_MAC_GAIN 123
#define LGW_ADJUST_MODEM_START_OFFSET_RDX8 124
#define LGW_ADJUST_MODEM_START_OFFSET_RDX4 125
#define LGW_ADJUST_MODEM_START_OFFSET_SF12_RDX4 126
#define LGW_DBG_CORR_SELECT_SF 127
#define LGW_DBG_CORR_SELECT_CHANNEL 128
#define LGW_DBG_DETECT_CPT 129
#define LGW_DBG_SYMB_CPT 130
#define LGW_CHIRP_INVERT_RX 131
#define LGW_DC_NOTCH_EN 132
#define LGW_IMPLICIT_CRC_EN 133
#define LGW_IMPLICIT_CODING_RATE 134
#define LGW_IMPLICIT_PAYLOAD_LENGHT 135
#define LGW_FREQ_TO_TIME_INVERT 136
#define LGW_FREQ_TO_TIME_DRIFT 137
#define LGW_PAYLOAD_FINE_TIMING_GAIN 138
#define LGW_PREAMBLE_FINE_TIMING_GAIN 139
#define LGW_TRACKING_INTEGRAL 140
#define LGW_FRAME_SYNCH_PEAK1_POS 141
#define LGW_FRAME_SYNCH_PEAK2_POS 142
#define LGW_PREAMBLE_SYMB1_NB 143
#define LGW_FRAME_SYNCH_GAIN 144
#define LGW_SYNCH_DETECT_TH 145
#define LGW_LLR_SCALE 146
#define LGW_SNR_AVG_CST 147
#define LGW_PPM_OFFSET 148
#define LGW_MAX_PAYLOAD_LEN 149
#define LGW_ONLY_CRC_EN 150
#define LGW_ZERO_PAD 151
#define LGW_DEC_GAIN_OFFSET 152
#define LGW_CHAN_GAIN_OFFSET 153
#define LGW_FORCE_HOST_REG_CTRL 154
#define LGW_FORCE_HOST_RADIO_CTRL 155
#define LGW_FORCE_HOST_FE_CTRL 156
#define LGW_FORCE_DEC_FILTER_GAIN 157
#define LGW_MCU_RST_0 158
#define LGW_MCU_RST_1 159
#define LGW_MCU_SELECT_MUX_0 160
#define LGW_MCU_SELECT_MUX_1 161
#define LGW_MCU_CORRUPTION_DETECTED_0 162
#define LGW_MCU_CORRUPTION_DETECTED_1 163
#define LGW_CHANN_SELECT_RSSI 164
#define LGW_RSSI_BB_DEFAULT_VALUE 165
#define LGW_RSSI_DEC_DEFAULT_VALUE 166
#define LGW_RSSI_CHANN_DEFAULT_VALUE 167
#define LGW_RSSI_BB_FILTER_ALPHA 168
#define LGW_RSSI_DEC_FILTER_ALPHA 169
#define LGW_RSSI_CHANN_FILTER_ALPHA 170
#define LGW_IQ_MISMATCH_A_AMP_COEFF 171
#define LGW_IQ_MISMATCH_A_PHI_COEFF 172
#define LGW_IQ_MISMATCH_B_AMP_COEFF 173
#define LGW_IQ_MISMATCH_B_SEL_I 174
#define LGW_IQ_MISMATCH_B_PHI_COEFF 175
#define LGW_TX_TRIG_IMMEDIATE 176
#define LGW_TX_TRIG_DELAYED 177
#define LGW_TX_TRIG_GPS 178
#define LGW_TX_START_DELAY 179
#define LGW_TX_FRAME_SYNCH_PEAK1_POS 180
#define LGW_TX_FRAME_SYNCH_PEAK2_POS 181
#define LGW_TX_OFFSET_I 182
#define LGW_TX_OFFSET_Q 183
#define LGW_TX_MODE 184
#define LGW_TX_ZERO_PAD 185
#define LGW_TX_EDGE_SELECT 186
#define LGW_TX_GAIN 187
#define LGW_TX_CHIRP_LOW_PASS 188
#define LGW_TX_FCC_WIDEBAND 189
#define LGW_TX_SWAP_IQ 190
#define LGW_MBWSSF_IMPLICIT_HEADER 191
#define LGW_MBWSSF_IMPLICIT_CRC_EN 192
#define LGW_MBWSSF_IMPLICIT_CODING_RATE 193
#define LGW_MBWSSF_IMPLICIT_PAYLOAD_LENGHT 194
#define LGW_MBWSSF_AGC_FREEZE_ON_DETECT 195
#define LGW_MBWSSF_FRAME_SYNCH_PEAK1_POS 196
#define LGW_MBWSSF_FRAME_SYNCH_PEAK2_POS 197
#define LGW_MBWSSF_PREAMBLE_SYMB1_NB 198
#define LGW_MBWSSF_FRAME_SYNCH_GAIN 199
#define LGW_MBWSSF_SYNCH_DETECT_TH 200
#define LGW_MBWSSF_DETECT_MIN_SINGLE_PEAK 201
#define LGW_MBWSSF_DETECT_TRIG_SAME_PEAK_NB 202
#define LGW_MBWSSF_FREQ_TO_TIME_INVERT 203
#define LGW_MBWSSF_FREQ_TO_TIME_DRIFT 204
#define LGW_MBWSSF_PPM_CORRECTION 205
#define LGW_MBWSSF_PAYLOAD_FINE_TIMING_GAIN 206
#define LGW_MBWSSF_PREAMBLE_FINE_TIMING_GAIN 207
#define LGW_MBWSSF_TRACKING_INTEGRAL 208
#define LGW_MBWSSF_ZERO_PAD 209
#define LGW_MBWSSF_MODEM_BW 210
#define LGW_MBWSSF_RADIO_SELECT 211
#define LGW_MBWSSF_RX_CHIRP_INVERT 212
#define LGW_MBWSSF_LLR_SCALE 213
#define LGW_MBWSSF_SNR_AVG_CST 214
#define LGW_MBWSSF_PPM_OFFSET 215
#define LGW_MBWSSF_RATE_SF 216
#define LGW_MBWSSF_ONLY_CRC_EN 217
#define LGW_MBWSSF_MAX_PAYLOAD_LEN 218
#define LGW_TX_STATUS 219
#define LGW_SPI_RADIO_A__DATA 220
#define LGW_SPI_RADIO_A__DATA_READBACK 221
#define LGW_SPI_RADIO_A__ADDR 222
#define LGW_SPI_RADIO_A__CS 223
#define LGW_SPI_RADIO_B__DATA 224
#define LGW_SPI_RADIO_B__DATA_READBACK 225
#define LGW_SPI_RADIO_B__ADDR 226
#define LGW_SPI_RADIO_B__CS 227
#define LGW_RADIO_A_EN 228
#define LGW_RADIO_B_EN 229
#define LGW_RADIO_RST 230
#define LGW_LNA_A_EN 231
#define LGW_PA_A_EN 232
#define LGW_LNA_B_EN 233
#define LGW_PA_B_EN 234
#define LGW_PA_GAIN 235
#define LGW_LNA_A_CTRL_LUT 236
#define LGW_PA_A_CTRL_LUT 237
#define LGW_LNA_B_CTRL_LUT 238
#define LGW_PA_B_CTRL_LUT 239
#define LGW_CAPTURE_SOURCE 240
#define LGW_CAPTURE_START 241
#define LGW_CAPTURE_FORCE_TRIGGER 242
#define LGW_CAPTURE_WRAP 243
#define LGW_CAPTURE_PERIOD 244
#define LGW_LED_REG 245
#define LGW_MODEM_STATUS 246
#define LGW_VALID_HEADER_COUNTER_0 247
#define LGW_VALID_PACKET_COUNTER_0 248
...
#define LGW_SW_TEST_REG1 290
#define LGW_SW_TEST_REG2 291
#define LGW_SW_TEST_REG3 292

#define LGW_TOTALREGS 293
