...
const struct lgw_reg_s loregs[LGW_TOTALREGS] = {
    ...
    {-1,20,0,0,1,"PIC_AGC_PROG_RAM_BIST_STATUS",1,0},
    {-1,20,1,0,1,"PIC_ARB_PROG_RAM_BIST_STATUS",1,0},
    ...
    {-1,26,0,0,1,"PIC_AGC_DATA_RAM_BIST0_STATUS",1,0},
    {-1,26,1,0,1,"PIC_AGC_DATA_RAM_BIST1_STATUS",1,0},
    {-1,26,2,0,1,"PIC_ARB_DATA_RAM_BIST0_STATUS",1,0},
    {-1,26,3,0,1,"PIC_ARB_DATA_RAM_BIST1_STATUS",1,0},
    ...
    {0,101,0,0,1,"FORCE_HOST_CONFIG_CTRL",0,1},
    {0,101,1,0,1,"FORCE_HOST_SPI_MASTER_CTRL",0,1},
    {0,101,2,0,1,"FORCE_CHAN_GAIN",0,1},
    {0,101,3,0,1,"FORCE_DEC_FILTER_GAIN",0,1},
    {0,101,4,0,1,"FORCE_HOST_RADIO_CTRL",0,1},
    {0,102,0,0,1,"PIC16F84_RST_0",0,1},
    {0,102,1,0,1,"PIC16F84_RST_1",0,1},
    {0,102,2,0,1,"PIC16F84_SELECT_MUX_0",0,0},
    {0,102,3,0,1,"PIC16F84_SELECT_MUX_1",0,0},
    {0,102,4,0,1,"PIC16F84_CORRUPTION_DETECTED_0",1,0},
    {0,102,5,0,1,"PIC16F84_CORRUPTION_DETECTED_1",1,0},
    ...
    {2,34,0,0,1,"RADIO_EN",0,0},
    {2,34,1,0,1,"RADIO_RST",0,0},
    {2,34,2,0,1,"RXTX_A",0,0},
    {2,34,3,0,1,"RXTX_B",0,0},
    {2,34,4,0,2,"PA_GAIN_A",0,0},
    {2,34,6,0,2,"PA_GAIN_B",0,0},
    {2,35,0,0,8,"SPI_RADIO_B__DATA",0,0},
    {2,36,0,0,8,"SPI_RADIO_B__DATA_READBACK",1,0},
    {2,37,0,0,14,"SPI_RADIO_B__ADDR",0,0},
    {2,39,0,0,1,"SPI_RADIO_B__CS",0,0},
    {2,40,0,0,5,"CAPTURE_SOURCE",0,0},
    {2,40,5,0,1,"CAPTURE_START",0,0},
    {2,40,6,0,1,"CAPTURE_FORCE_TRIGGER",0,0},
    {2,40,7,0,1,"CAPTURE_WRAP",0,0},
    {2,41,0,0,16,"CAPTURE_PERIOD",0,0},
    {2,43,0,0,3,"LED_REG",0,3},
    {2,44,0,0,8,"MODEM_STATUS",1,0},
    {2,45,0,0,8,"VALID_HEADER_COUNTER_0",1,0},
    {2,46,0,0,8,"VALID_HEADER_COUNTER_1",1,0},
    {2,47,0,0,8,"VALID_PACKET_COUNTER_0",1,0},
    {2,48,0,0,8,"VALID_PACKET_COUNTER_1",1,0},
    {2,49,0,0,8,"VALID_HEADER_COUNTER_MBWSSF",1,0},
    {2,50,0,0,8,"VALID_HEADER_COUNTER_FSK",1,0},
    {2,51,0,0,8,"VALID_PACKET_COUNTER_MBWSSF",1,0},
    {2,52,0,0,8,"VALID_PACKET_COUNTER_FSK",1,0},
    {2,53,0,0,8,"CHANN_RSSI",1,0},
    {2,54,0,0,8,"BB_RSSI",1,0},
    {2,55,0,0,8,"DEC_RSSI",1,0},
    {2,56,0,0,8,"DBG_PIC_DATA",1,0},
    {2,57,0,0,8,"DBG_ARB_PIC_RAM_DATA",1,0},
    {2,58,0,0,8,"DBG_AGC_PIC_RAM_DATA",1,0},
    {2,59,0,0,16,"NEXT_PACKET_CNT",1,0},
    {2,61,0,0,16,"ADDR_CAPTURE_COUNT",1,0},
    {2,63,0,0,32,"TIMESTAMP",1,0},
    {2,67,0,0,4,"DBG_CHANN0_GAIN",1,0},
    {2,67,4,0,4,"DBG_CHANN1_GAIN",1,0},
    {2,68,0,0,4,"DBG_CHANN2_GAIN",1,0},
    {2,68,4,0,4,"DBG_CHANN3_GAIN",1,0},
    {2,69,0,0,4,"DBG_CHANN4_GAIN",1,0},
    {2,69,4,0,4,"DBG_CHANN5_GAIN",1,0},
    {2,70,0,0,4,"DBG_CHANN6_GAIN",1,0},
    {2,70,4,0,4,"DBG_CHANN7_GAIN",1,0},
    {2,71,0,0,4,"DBG_DEC_FILT_GAIN",1,0},
    {2,72,0,0,3,"SPI_DATA_FIFO_PTR",1,0},
    {2,72,3,0,3,"PACKET_DATA_FIFO_PTR",1,0},
    {2,73,0,0,8,"DBG_ARB_PIC_RAM_ADDR",0,0},
    {2,74,0,0,8,"DBG_AGC_PIC_RAM_ADDR",0,0},
    {2,75,0,0,1,"SPI_MASTER_CHIP_SELECT_POLARITY",0,0},
    {2,75,1,0,1,"SPI_MASTER_CPOL",0,0},
    {2,75,2,0,1,"SPI_MASTER_CPHA",0,0},
    {2,76,0,0,1,"SIG_GEN_ANALYSER_MUX_SEL",0,0},
    {2,77,0,0,1,"SIG_GEN_EN",0,0},
    {2,77,1,0,1,"SIG_ANALYSER_EN",0,0},
    {2,77,2,0,2,"SIG_ANALYSER_AVG_LEN",0,0},
    {2,77,4,0,3,"SIG_ANALYSER_PRECISION",0,0},
    {2,77,7,0,1,"SIG_ANALYSER_VALID_OUT",1,0},
    {2,78,0,0,8,"SIG_GEN_FREQ",0,0},
    {2,79,0,0,8,"SIG_ANALYSER_FREQ",0,0},
    {2,80,0,0,8,"SIG_ANALYSER_I_OUT",1,0},
    {2,81,0,0,8,"SIG_ANALYSER_Q_OUT",1,0},
    {2,82,0,0,1,"GPS_EN",0,0},
    {2,82,1,0,1,"GPS_POL",0,1}
};
