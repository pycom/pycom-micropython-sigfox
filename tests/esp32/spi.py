...
SPI(id=0, mode=SPI.MASTER, polarity=0, phase=0, pins=spi_pins)
SPI(0, SPI.MASTER, polarity=0, phase=0, pins=spi_pins)
...
spi.init(polarity=1, phase=1, pins=spi_pins)
buffer_r = bytearray(10)
spi.write_readinto(buffer_w, buffer_r)
print(buffer_w == buffer_r)

spi.init(polarity=0, phase=1, pins=spi_pins)
buffer_r = bytearray(10)
spi.write_readinto(buffer_w, buffer_r)
print(buffer_w == buffer_r)
...
spi.init(SPI.MASTER, baudrate=10000000, bits=16, polarity=0, phase=0, pins=spi_pins)
print(spi.write_readinto(buffer_w, buffer_r) == 12)
print(buffer_w == buffer_r)

buffer_r = bytearray(12)
spi.init(SPI.MASTER, baudrate=10000000, bits=32, polarity=0, phase=0, pins=spi_pins)
print(spi.write_readinto(buffer_w, buffer_r) == 12)
print(buffer_w == buffer_r)
